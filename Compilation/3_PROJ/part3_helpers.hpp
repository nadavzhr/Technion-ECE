...
// Register for the Return Adress
#define RA "I0"
...
static int currentScopeRegsNumInt = 3; // Number of registers in use in the current function
static int currentScopeRegsNumFloat = 3; // Number of registers in use in the current function
...
static string currentVariadicFuncName;
static vector<int> runTimeErrorList;
/**********************************************************************************************/
